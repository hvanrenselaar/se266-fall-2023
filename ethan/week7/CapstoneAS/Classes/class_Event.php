<?php
    ...
    class EventRequirement {
        protected $id, $drink, $style, $brewer, $reqType, $value;
    ...
    class EventRequirements extends GenericCollection{
        ...
        public function newRequirement($beer = null, $style = null, $brewer = null){
            array_push($this->eventRequirements, new EventRequirement($beer, $style, $brewer));
        }
    ...
    class Event implements JsonSerializable{
        protected $name, $eventStart, $eventEnd, $requiredDrinks, $id;
        ...
        public function __construct ($name, $eventStart, $eventEnd, EventRequirements $requiredDrinks = null, $id = null) {
            ...
            $this->requiredDrinks = $requiredDrinks; //using a collection class that will output a list of the requirement objects
            $this->id = $id;
        }
        ...
        public function AddReq($drink = null, $style = null, $brewer = null)
        {
            $this->requiredDrinks->newRequirement($drink, $style, $brewer);
        }
    ...
    // $test = new Event("test", new DateTime(), new DateTime(), new EventRequirements());
    // $test->AddReq($style = "stout");
    // $test->AddReq($beer = 3);
    // $reqsArray = $test->Requirements()->toArray();
