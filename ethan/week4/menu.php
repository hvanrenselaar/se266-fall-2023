...
<div class="w3-nav">
    <div class="w3-grey w3-bar">
        <div class="row row-no-gutters">
            ...
            <div class="col-sm-1">    
                <a href="#" class="w3-bar-item w3-button w3-padding-large w3-white">Week 4</a>
            </div>
            <div class="col-sm-1">
    ...
    <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
        ...
        <a href="#" class="w3-bar-item w3-button w3-padding-large">Week 4</a>
...
<div class="w3-container">
    <div class="row">
        <h3 class="col-sm-4 text-left">SE266 </h3>
        <h1 class="col-sm-4 text-center">Ethan Markham</h1>
        <h3 class="col-sm-4 text-right">Spring 2020</h3>
    </div>
</div>
